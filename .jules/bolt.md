...
## 2026-07-08 - Hoisting Expensive Lookups outside Frame-Bound Loops
...
**Action:** Always hoist and cache these lookups outside the loop to eliminate O(N) lookup overhead and reduce string hashing per frame.

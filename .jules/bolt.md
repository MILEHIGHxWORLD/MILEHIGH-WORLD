...
## 2026-07-27 - Wave Function Collapse Dynamic GC Allocations
**Learning:** In asynchronous chunk generation (e.g., deeply nested Wave Function Collapse algorithms), repeatedly allocating local collections (like List<T>) or arrays inside loops generates massive GC overhead.
**Action:** Replace dynamic allocations with single-variable trackers or static readonly arrays in deterministic selection algorithms.

...
## 2026-08-02 - [Hoist Expensive Operations out of Frame-bound Loops]
...
**Action:** Always hoist and cache these lookups outside the loop, such as caching the int from Shader.PropertyToID(string) and storing component references, to eliminate redundant per-frame overhead.

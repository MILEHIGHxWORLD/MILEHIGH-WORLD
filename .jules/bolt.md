...
## 2026-07-19 - Hoisting Lookups Outside Async Yield Loops
...
**Action:** Always hoist and cache these lookups outside the loop. Cache string properties using `Shader.PropertyToID` to eliminate redundant string hashing overhead per frame.

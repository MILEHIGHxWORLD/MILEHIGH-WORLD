...
## 2026-07-10 - Hoisting Lookups Outside Frame-bound Loops
...
**Action:** Always hoist and cache these lookups outside the loop. Use `Shader.PropertyToID` for shader properties, and cache components and dictionary lookups before entering the loop.

...
## 2026-08-03 - [Hoist Lookups Outside Async Loops]
...
**Action:** Always hoist and cache these lookups outside the loop, and explicitly use explicit null checks instead of the null-conditional operator on Unity objects to preserve custom lifecycle checks.

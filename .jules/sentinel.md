...
## 2026-05-24 - Missing Blocklist for RealitySyncEngine
**Vulnerability:** The RealitySyncEngine singleton was omitted from the _protectedManagers IDOR blocklist in SceneDirector.cs, allowing unauthorized state manipulation.
**Learning:** Hardcoded security blocklists are prone to omissions when new core managers are introduced.
**Prevention:** Establish an automated or attribute-based registry for core singletons instead of manually maintaining a string blocklist.

...
namespace MilehighWorld.World.Terminal
{
    public class OtisTerminal : MonoBehaviour
    {
        ...
        private string _inputBuffer = ""; // Palette: Unsent input buffer preserved during history browsing.
        ...
        private void NavigateHistory(int direction)
        {
            ...
            // Palette: Preserve unsent input when leaving the live command line
            if (_historyIndex == _commandHistory.Count && newIndex < _historyIndex)
            {

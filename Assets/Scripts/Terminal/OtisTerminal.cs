...
namespace MilehighWorld.World.Terminal
{
    public class OtisTerminal : MonoBehaviour
    {
        ...
        private string _inputBuffer = ""; // Palette: Buffer to save in-progress command when navigating history.
        ...
        private void Update()
        {
            ...
            // Palette: Shortcut - Escape key clears the input line and resets the history index/suggestions,
            // but only if the input is not already empty, preserving global menu handlers.
        ...
        private void NavigateHistory(int direction)
        {
            ...
            // Save currently typed text if we are leaving the "new line" input state

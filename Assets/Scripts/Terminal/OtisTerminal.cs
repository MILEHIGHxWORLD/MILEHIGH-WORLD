...
namespace MilehighWorld.World.Terminal
{
    public class OtisTerminal : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // Palette: Quick Escape shortcut to clear input line and reset suggestions/history index.
        ...
        public void ProcessCommand(string input)
        {
            ...
            if (command == "help")
            {
                WriteToTerminal("\n[SYSTEM]: <color=#FFFF00>Available Commands:</color>" +
                                ...
                                "\n\n[SYSTEM]: <color=#FFFF00>Shortcuts:</color> Up/Down (History), Tab (Fix/Autocomplete), Ctrl+L (Clear Output), Esc (Clear Line)." +

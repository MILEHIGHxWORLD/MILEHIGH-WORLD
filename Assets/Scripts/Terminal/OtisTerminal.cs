...
namespace MilehighWorld.World.Terminal
{
    public class OtisTerminal : MonoBehaviour
    {
        ...
        private string _inputBuffer = ""; // Palette: Preserve unsent typed text during history navigation.
        ...
        private void NavigateHistory(int direction)
        {
            ...
            // Save unsent typed text when leaving the current active line
            if (_historyIndex == _commandHistory.Count)
            {
                _inputBuffer = commandInput != null ? commandInput.text : "";
            }

...
namespace MilehighWorld.World.Terminal
{
    public class OtisTerminal : MonoBehaviour
    {
        ...
        private string _inputBuffer = ""; // Palette: Draft buffer to preserve unsent input during history navigation.
        ...
        private void NavigateHistory(int direction)
        {
            ...
            // Palette: Save unsent draft input when navigating away from the current line

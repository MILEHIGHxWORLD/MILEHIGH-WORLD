...
namespace MilehighWorld.World.Terminal
{
    public class OtisTerminal : MonoBehaviour
    {
        ...
        private string _inputBuffer = ""; // Palette: Track unsent user draft when navigating history.

        private void Start()
        {
            _historyIndex = _commandHistory.Count; // Palette: Enable predictable history navigation.
        ...
        private void Update()
        {
            ...
            // Palette: Escape shortcut to clear line and reset navigation without global interference.
        ...
        private void NavigateHistory(int direction)
        {
            ...
            // Save unsent user input as a draft before navigating up.
        ...
        public void ProcessCommand(string input)
        {
            ...
            _historyIndex = _commandHistory.Count;
            _lastSuggestion = "";
            _inputBuffer = ""; // Reset draft buffer on successful command submit.

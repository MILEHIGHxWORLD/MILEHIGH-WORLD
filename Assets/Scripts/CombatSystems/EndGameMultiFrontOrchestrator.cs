...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt:
            // 💡 What: Cached component lookup, dictionary lookup, and shader property IDs outside the loop.
            // 🎯 Why: GetComponent, dictionary lookups, and string-based shader property updates inside a frame-bound async loop cause significant per-frame CPU and string hashing overhead.

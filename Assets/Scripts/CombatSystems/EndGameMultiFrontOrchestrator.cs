...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt:
            // 💡 What: Hoist component lookups, dictionary lookups, and shader property IDs outside the loop.
            // 🎯 Why: Prevents significant per-frame CPU overhead and string hashing from native/managed boundary crossings.
            // 📊 Impact: Eliminates redundant GC allocations and reduces per-frame execution time.

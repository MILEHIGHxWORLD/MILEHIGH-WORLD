...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt: Cache component lookups and property IDs outside the loop
            // 💡 What: Hoisted GetComponent, GetAlly, and Shader.PropertyToID calls out of the async loop.
            // 🎯 Why: Repeatedly executing these calls inside a frame-bound loop causes unnecessary CPU overhead and string hashing.
            // 📊 Impact: Eliminates native/managed boundary crossings and dictionary lookups per frame, improving runtime performance.

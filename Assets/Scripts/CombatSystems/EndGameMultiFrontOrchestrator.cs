...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt:
            // 💡 What: Cache dictionary lookups, Component lookups, and shader property IDs outside the loop.
            // 🎯 Why: Prevents significant per-frame CPU overhead and string hashing from native/managed boundary crossings during async execution.
            // 📊 Impact: Eliminates redundant O(N) component searches and dictionary lookups per frame.

...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // 🎯 Why: Executing these lookups inside a frame-bound async loop causes significant C#/C++ native boundary crossings and string hashing overhead.
            // 📊 Impact: Eliminates redundant per-frame CPU overhead and GC allocations.

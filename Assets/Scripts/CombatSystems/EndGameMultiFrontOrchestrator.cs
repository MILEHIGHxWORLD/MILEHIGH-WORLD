...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt:
            // 💡 What: Hoist expensive operations (GetComponent, Dictionary lookups, String hashing) outside the loop.
            // 🎯 Why: Prevents redundant native/managed crossings, GC overhead, and string hashing per-frame.
            // 📊 Impact: Significantly reduces CPU time during the cinematic loop and eliminates micro-stutters.

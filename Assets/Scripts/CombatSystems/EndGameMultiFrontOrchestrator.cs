...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt:
            // 💡 What: Hoisted component lookups, dictionary accesses, and Shader.PropertyToID outside the loop.
            // 🎯 Why: Executing GetComponent, GetAlly, and string-based SetFloat inside a frame-bound async loop causes significant per-frame CPU overhead and string hashing due to native/managed boundary crossings.
            // 📊 Impact: Eliminates redundant O(N) traversals and dictionary lookups per frame, preserving frame rate stability.

...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt:
            // 💡 What: Cached Rigidbody, Reverie ally, and shader property IDs before the while loop.
            // 🎯 Why: Calling GetComponent, dictionary lookups, and string-based SetFloat in a frame-bound loop causes significant per-frame CPU overhead and string hashing overhead.
            // 📊 Impact: Eliminates native/managed boundary crossings and redundant memory allocations per frame.

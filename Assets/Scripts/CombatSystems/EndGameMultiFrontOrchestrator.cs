...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt:
            // 💡 What: Hoist GetComponent, dictionary lookups, and Shader.PropertyToID outside the loop.
            // 🎯 Why: Repeatedly executing these inside a frame-bound async loop causes significant CPU and GC overhead.
            // 📊 Impact: Eliminates per-frame string hashing and native/managed boundary crossing overhead.

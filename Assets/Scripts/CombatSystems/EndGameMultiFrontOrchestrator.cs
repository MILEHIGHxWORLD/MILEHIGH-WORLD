...
namespace MilehighWorld.CombatSystems
{
    public class EndGameMultiFrontOrchestrator : MonoBehaviour
    {
        ...
        public async Task CoordinateFinalNexusLockAsync(EncounterDirector director, LatticeSynchronizer synchronizer)
        {
            ...
            // ⚡ Bolt Optimization
            // 💡 What: Hoisted GetComponent, GetAlly, and Shader.PropertyToID outside the frame-bound loop.
            // 🎯 Why: Calling these inside a while loop with Task.Yield() causes significant per-frame CPU overhead and string hashing overhead.
            // 📊 Impact: Eliminates native/managed boundary crossings and redundant string hashing per frame.

...
namespace MilehighWorld.Cinematics
{
    ...
    public class Cinematic_IntoTheVoid : MonoBehaviour
    {
        ...
        private GameObject? _skipHintInstance;
        ...
        private void Start()
        {
            ...
            {
                _skipHintInstance = dialogueCanvas.transform.Find("SkipHint")?.gameObject;
                if (_skipHintInstance != null) _skipHintInstance.SetActive(false);
            }
        ...
        private void Update()
        {
            ...
            if (Input.anyKeyDown)
            {
                ...
                if (_skipHintInstance != null && _skipHintInstance.activeSelf) _skipHintInstance.SetActive(false);
            ...
            else
            {
                ...
                {
                    if (_skipHintInstance != null && !_skipHintInstance.activeSelf) _skipHintInstance.SetActive(true);
        ...
        private async Task PopScaleAsync(Transform target, float duration, float scaleFactor)
        {
            ...
            while (elapsed < duration)
            {
                ...
                float scale = 1.0f + Mathf.Sin(t * Mathf.PI) * (scaleFactor - 1.0f);
